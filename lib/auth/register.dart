...
class Register extends StatefulWidget {
  const Register({super.key, required this.changeIsReg});
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Ro'yxatdan o'tish",
                            style: MyDecoration.textStyle.copyWith(color: MyColors.secondaryColor, fontSize: 27, fontWeight: FontWeight.bold)),
                        Padding(
                          ...
                          child: TextFormField(
                              ...
                              decoration: MyDecoration.inputDecoration.copyWith(labelText: "F.I.O.")),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 14),
                          child: TextFormField(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text("Profil mavjud bo'lsa: ",
                          style: MyDecoration.textStyle.copyWith(color: MyColors.secondaryColor, fontSize: 17, fontWeight: FontWeight.normal)),
                      GestureDetector(
                          onTap: () {
                            widget.changeIsReg();
                          },
                          child: Text("Kirish", style: MyDecoration.textStyle.copyWith(color: MyColors.blueColor, fontSize: 17, fontWeight: FontWeight.bold))),
                    ],
                  ),
                ],
              ),
                ...
                child: Padding(
                  ...
                  child: myButton(
                      function: () async {
                        ...
                        await AuthService().registerWithEmailAndPassword(login: tel, password: password, name: name, type: 'director');
                      },
                      child: const Text("Ro'yxatdan o'tish", style: MyDecoration.textStyle)),
                )),
          ],
        ),
      ),
